...
class Config
{
	...
	**/
	...
	{
		if (save.data.isdownscroll == null)
			save.data.isdownscroll = false;
	...
	{
		if (save.data.cutscenes == null)
			save.data.cutscenes = true;
	...
	{
		if (save.data.splash == null)
			save.data.splash = true;
